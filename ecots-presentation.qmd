...
* Chose a friend's college to be the answer.
...
* Can use **real data** for follow-up analysis.
...
* Needed text with a **frequent character** to replace.
...
* Easy to make **more or less complex**.
...
* ... **quick start:** doing the first few steps of the puzzle together or with more guidance.
...
* Creates a **us versus puzzle** student teamwork mentality.
